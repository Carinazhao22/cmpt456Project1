...
public class TFIDFHtmlIndexFiles {
    ...
    static void indexDoc(IndexWriter writer, Path file, long lastModified) throws IOException {
        try (InputStream stream = Files.newInputStream(file)) {
            ...
            res = htmlParser.parse(res,"",null,new BufferedReader(new InputStreamReader(stream, StandardCharsets.UTF_8)),null);
            ...
            //https://www.programcreek.com/java-api-examples/?api=org.apache.lucene.document.TextField
